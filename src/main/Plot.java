...
public class Plot extends Canvas {
	...
	public synchronized void addLine(Point p1, Point p2) {
		...
		int pixely1 = (int) Math.round(plotHeight * (yMax-p1.getY()) / yRange);	
